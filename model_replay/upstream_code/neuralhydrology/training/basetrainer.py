...
class BaseTrainer(object):
    ...
    def __init__(self, cfg: Config):
        ...
        self._epoch = self._get_start_epoch_number()   # train half hll
    ...
    def _train_epoch(self, epoch: int):
        ...
        for data in pbar:
            ...
            # get predictions
            predictions = self.model(data, self._scaler)   # hll
    ...
    def _create_folder_structure(self):
        ...
        # create as new folder structure
            ...
            run_name = f'{self.cfg.experiment_name}_{self.cfg.seed}_{day}{month}_{hour}{minute}{second}'     # hll
