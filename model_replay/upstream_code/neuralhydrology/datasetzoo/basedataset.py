...
from ruamel.yaml import YAML   #### hll
# import yaml
...
class BaseDataset(Dataset):
    ...
    def _load_or_create_xarray_dataset(self) -> xarray.Dataset:
        ...
        if (self.cfg.train_data_file is None) or (not self.is_train):
            ...
            keep_cols = self.cfg.target_variables + self.cfg.evolving_attributes + self.cfg.mass_inputs + self.cfg.autoregressive_inputs   ##hll may add
